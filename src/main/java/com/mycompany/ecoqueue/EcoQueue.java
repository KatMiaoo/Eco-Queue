...
public class EcoQueue extends javax.swing.JFrame {
    ...
    public EcoQueue() {
        initComponents();
        jpassword.setText(""); //Clear default password
        addActionListeners();
    }
    
    private void addActionListeners() {
        // Show/Hide password
        jshowtext.addActionListener(e -> {
            if (jshowtext.isSelected()) {
        ...
        jtuser.addActionListener(this::jloginActionPerformed);
        jpassword.addActionListener(this::jloginActionPerformed);
    }
    ...
    private void initComponents() {
        ...
        LogoImage.setIcon(new javax.swing.ImageIcon("C:\\Users\\schal\\OneDrive\\Documents\\NetBeansProjects\\Eco-Queue\\src\\main\\resources\\Image-EcoQueue\\rsz_eco_logo_no_bg.png")); // NOI18N
